...
appimagetool-x86_64.AppImage $appdir /tmp/TrixieDiamonds32-EN-1.0.0-x86_64.AppImage

echo "\"ru\"" > $appdir/usr/data/deflang.json
appimagetool-x86_64.AppImage $appdir /tmp/TrixieDiamonds32-RU-1.0.0-x86_64.AppImage
